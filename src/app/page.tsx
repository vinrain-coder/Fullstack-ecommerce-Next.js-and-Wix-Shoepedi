...
async function FeaturedProducts() {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex grid-cols-2 flex-col gap-5 sm:grid md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
...
function LoadingSkeleton() {
  return (
    <div className="flex grid-cols-2 flex-col gap-5 pt-12 sm:grid md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
